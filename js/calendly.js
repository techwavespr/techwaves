(() => {
  ...
  (() => {
    "use strict";
    e.r(t), e.d(t, { closePopupWidget: () => _, destroyBadgeWidget: () => U, initBadgeWidget: () => R, initInlineWidget: () => x, initPopupWidget: () => W, showPopupWidget: () => I });
    const o = (e) => {
    ...
    class h {
      ...
      parseOptions() {
        if (((this.options = Object.assign({}, { inlineStyles: !1, resize: !1 }, this.options)), (this.parent = this.options.parentElement), !this.parent)) throw new Error("Calendly: Parent element not set");
        if (
      ...
      onLoadIframe() {
        // console.log('onLoadIframe ///// / //  // // /', this);
        // var head = this.contentWindow.document;
      ...
      build() {
        (this.node = document.createElement("iframe")), (this.node.dataset.src = this.getSource()), (this.node.width = "100%"), (this.node.height = "100%"), (this.node.frameBorder = "0"), (this.node.title = "Select a Date & Time - Calendly"), (this.node.onload = this.onLoadIframe);
      }
      getSource() {
      ...
      getQuery() {
        return (
          (e = p(p(p({ embed_domain: this.getDomain(), embed_type: this.embedType }, this.getUtmParamsFromHost()), this.getParamsFromUrl()), this.getParamsFromOptions())),
            `?${Object.entries(e)
      ...
      unlockPageScroll() {
        ...
        return (
          (e = this.overlay)
            ...
            v && ((e.ontouchstart = null), (e.ontouchmove = null), f && 0 === g.length && (document.removeEventListener("touchmove", S, y ? { passive: !1 } : void 0), (f = !1))),
              v
                ? (function () {
                  if (void 0 !== C) {
                ...
                : (void 0 !== O && ((document.body.style.paddingRight = O), (O = void 0)), void 0 !== P && ((document.body.style.overflow = P), (P = void 0))))
    ...
    o(() => {
      ...
      Array.from(e).forEach((e) => {
        ((e) => e.getAttribute("data-processed") || "false" === e.getAttribute("data-auto-load"))(e) || (e.setAttribute("data-processed", !0), new h({ parentElement: e, inlineStyles: !0, embedType: "Inline", resize: M(e) }).inject());
      });
    });
  })();
